    ...
    >
      ...
      <div>
        ...
        <div className='w-[90%] mx-auto my-12 py-8 px-10 bg-white rounded-lg shadow-sm hover:shadow-lg transition ease-in-out'>
          <form>
            <h4 className='text-2xl mb-3 text-[#102a43] capitalize'>add job</h4>
            <div className='grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-y-8 gap-x-4'>
              ...
              <button className='flex mb-0 bg-gray-600 hover:bg-gray-700 py-4 px-10 hover:text-white justify-center capitalize items-center h-9 rounded-md self-end text-white'>
                clear
              </button>
            </div>
          </form>
